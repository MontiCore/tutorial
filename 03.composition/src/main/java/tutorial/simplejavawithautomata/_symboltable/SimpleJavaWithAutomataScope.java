...
package tutorial.simplejavawithautomata._symboltable;
...
public class SimpleJavaWithAutomataScope extends SimpleJavaWithAutomataScopeTOP {

  public SimpleJavaWithAutomataScope() {
    super();
  }

  public SimpleJavaWithAutomataScope(boolean isShadowingScope) {
    super(isShadowingScope);
  }

  public SimpleJavaWithAutomataScope(ISimpleJavaWithAutomataScope enclosingScope) {
    this(enclosingScope, false);
  }

  public SimpleJavaWithAutomataScope(ISimpleJavaWithAutomataScope enclosingScope, boolean isShadowingScope) {
