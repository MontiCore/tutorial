...
import de.monticore.gettingstarted.simplejavawithautomata.cocos.SimpleJavaWithAutomataCoCos;
...
public class CoCoTest extends AbstractTest {
  ...
  public void setup() throws IOException {
    ...
    this.bar = parse("src/test/resources/de/monticore/gettingstarted/simplejava/valid/Bar.java");
    stc.createFromAST(this.bar);

    stc = new SimpleJavaWithAutomataPhasedSTC();
    this.inheritanceBar = parse("src/test/resources/de/monticore/gettingstarted/simplejava/valid/InheritanceBar.java");
    stc.createFromAST(this.inheritanceBar);

    stc = new SimpleJavaWithAutomataPhasedSTC();
    this.staticAbstractOOMethods = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/StaticAbstractOOMethods.java");
    stc.createFromAST(this.staticAbstractOOMethods);

    stc = new SimpleJavaWithAutomataPhasedSTC();
    this.staticAbstractOOFields = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/StaticAbstractOOFields.java");
    stc.createFromAST(this.staticAbstractOOFields);

    stc = new SimpleJavaWithAutomataPhasedSTC();
    this.check = parse("src/test/resources/de/monticore/gettingstarted/simplejavawithautomata/Check.jla");
    stc.createFromAST(this.check);

    stc = new SimpleJavaWithAutomataPhasedSTC();
    this.invalidAutomaton = parse("src/test/resources/de/monticore/gettingstarted/simplejavawithautomata/invalid/InvalidAutomaton.jla");
    stc.createFromAST(this.invalidAutomaton);

    stc = new SimpleJavaWithAutomataPhasedSTC();
    this.wrongAssignment = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/WrongAssignment.java");
    stc.createFromAST(this.wrongAssignment);

    stc = new SimpleJavaWithAutomataPhasedSTC();
    this.complicatedWrongAssignment = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/ComplicatedWrongAssignment.java");
    stc.createFromAST(this.complicatedWrongAssignment);

    stc = new SimpleJavaWithAutomataPhasedSTC();
    this.complicatedCorrectAssignment = parse("src/test/resources/de/monticore/gettingstarted/simplejava/valid/ComplicatedCorrectAssignment.java");
    stc.createFromAST(this.complicatedCorrectAssignment);

    stc = new SimpleJavaWithAutomataPhasedSTC();
    this.inheritedCannotUseStaticFromSuper = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/InheritedCannotUseStaticFromSuper.java");
