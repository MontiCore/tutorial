...
public class SimpleJavaScope extends SimpleJavaScopeTOP {

  public SimpleJavaScope() {
    super();
  }

  public SimpleJavaScope(boolean isShadowingScope) {
    super(isShadowingScope);
  }

  public SimpleJavaScope(ISimpleJavaScope enclosingScope) {
    this(enclosingScope, false);
  }

  public SimpleJavaScope(ISimpleJavaScope enclosingScope, boolean isShadowingScope) {
