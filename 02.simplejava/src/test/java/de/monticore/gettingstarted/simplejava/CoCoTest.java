...
public class CoCoTest extends AbstractTest {
  ...
  public void setup() throws IOException {
    ...
    this.bar = parse("src/test/resources/de/monticore/gettingstarted/simplejava/valid/Bar.sjava");
    stc.createFromAST(this.bar);

    stc = new SimpleJavaPhasedSTC();
    this.inheritanceBar = parse("src/test/resources/de/monticore/gettingstarted/simplejava/valid/InheritanceBar.sjava");
    stc.createFromAST(this.inheritanceBar);

    stc = new SimpleJavaPhasedSTC();
    this.staticAbstractOOMethods = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/StaticAbstractOOMethods.sjava");
    stc.createFromAST(this.staticAbstractOOMethods);

    stc = new SimpleJavaPhasedSTC();
    this.staticAbstractOOFields = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/StaticAbstractOOFields.sjava");
    stc.createFromAST(this.staticAbstractOOFields);

    stc = new SimpleJavaPhasedSTC();
    this.check = parse("src/test/resources/de/monticore/gettingstarted/simplejava/valid/Check.sjava");
    stc.createFromAST(this.check);

    stc = new SimpleJavaPhasedSTC();
    this.wrongAssignment = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/WrongAssignment.sjava");
    stc.createFromAST(this.wrongAssignment);

    stc = new SimpleJavaPhasedSTC();
    this.complicatedWrongAssignment = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/ComplicatedWrongAssignment.sjava");
    stc.createFromAST(this.complicatedWrongAssignment);

    stc = new SimpleJavaPhasedSTC();
    this.complicatedCorrectAssignment = parse("src/test/resources/de/monticore/gettingstarted/simplejava/valid/ComplicatedCorrectAssignment.sjava");
    stc.createFromAST(this.complicatedCorrectAssignment);

    stc = new SimpleJavaPhasedSTC();
    this.inheritedCannotUseStaticFromSuper = parse("src/test/resources/de/monticore/gettingstarted/simplejava/invalid/InheritedCannotUseStaticFromSuper.sjava");
